...
class AlipaySubmit {
	...
	function buildRequestForm($para_temp, $method, $button_name) {
		...
		$sHtml = "<div style='display:none;'><form id='alipaysubmit' name='alipaysubmit' action='".$this->alipay_gateway_new."_input_charset=".trim(strtolower($this->alipay_config['input_charset']))."' method='".$method."'>";
		...
		$sHtml = $sHtml."<script>document.forms['alipaysubmit'].submit();</script></div>";
