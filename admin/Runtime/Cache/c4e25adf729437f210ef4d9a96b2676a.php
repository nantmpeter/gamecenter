...
<form action="<?php echo U('Game/gametype_add');?>" method="post" id="myform" enctype="multipart/form-data">
<table width="100%" class="table_form">
  <tbody>
  <tr>
    <th width="120">游戏类型</th>
    <td class="y-bg"><input type="text" class="input-text" name="typename" id="typename" size="30" >&nbsp;&nbsp;&nbsp;&nbsp;<font color="gray">输入游戏类型</font></td>
  </tr>
</tbody></table>
</div>
<div class="bk15"></div>
